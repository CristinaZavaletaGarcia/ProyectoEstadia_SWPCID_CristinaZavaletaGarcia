                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Hola,<span>Te encuentras dentro del formulario para registrar un nuevo coordinador</span></h1>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="col-lg-12">
                    <div class="registration-form">
                        <form action="../Modelo/CoordinadorRegistrar.php" method="POST" style="text-align: center">
                            <h1>Registro de un nuevo coordinador</h1>
                            <br>
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="apellidoP" required>
                                <br>
                                <label for="apellidoM">Apellido materno</label>
                                <input class="form-control" type="text" name="apellidoM" required>
                                <br>
                                <label for="telefono">Telefono</label>
                                <input class="form-control" type="text" min="10" max="10" pattern="[0-9]{0,10}" name="telefono" required>
                                <br>
                                <label for="correo_electronico">Correo electrnico</label>
                                <input class="form-control" type="mail" name="correo_electronico" required>
                                <br>
                                <label for="estatus_dato">Estatus</label>
                                <select name="estatus_dato" class="form-control" required >
                                ...
                                <input class="form-control" type="date" name="fecha_dato" value="<?php echo date("Y-m-d");?>" readonly>
                                <br>
                                <?php
                                    include("../Controlador/Conexion.php");
                                    $conexion =  mysqli_connect($servidor,$user,$password,$database);
                                    $sql2 = "SELECT * FROM tipos_usuarios where tipo='Coordinador'";
                                    $resultado = mysqli_query($conexion,$sql2);
                                ?>
                                <label for="idtipos_usuarios">Tipo de usuario</label>
                                <select name="idtipos_usuarios" class="form-control" readonly>
                                ...
                                ?>
                                <label for="iddepartamentos_usuario">Tipo de usuario</label>
                                <select name="iddepartamentos_usuario" class="form-control" required>
                                    <option value="">Selecciona una opción</option>
                                    <?php while($mostrar =  $resultado->fetch_assoc()) { ?>
