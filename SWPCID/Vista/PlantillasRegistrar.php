                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Hola,<span>Te encuentras dentro del formulario para registrar una nueva plantilla</span></h1>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="col-lg-12">
                    <div class="registration-form">
                        <form action="../Modelo/PlantillasRegistrar.php" method="POST" style="text-align: center" enctype="multipart/form-data">
                            <h1>Registro de una nueva plantilla</h1>
                            <br>
                            <div class="form-group">
                                <label for="ruta_plantilla">Documento que sera registrado:</label><br>
                                <input type="file" name="ruta_plantilla" required><br>
                                <br>
                                <label for="descripcion_plantillas">Descripción de la plantilla:</label>
                                <input class="form-control" type="text" name="descripcion_plantillas"  required>
                                <br>
                                <label for="fecha_plantilla">Fecha de registro:</label>
                                <input class="form-control" type="date" name="fecha_plantilla" value="<?php echo date("Y-m-d");?>" readonly>
                                <br>
                                <label for="estatus_plantilla">Estatus:</label>
                                <select name="estatus_plantilla"  class="form-control" readonly>
                                ...
                                ?>
                                <label for="tipo_documento">Tipo de usuario</label>
