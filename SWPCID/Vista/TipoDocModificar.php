...
<body>
    ...
    <div class="content-wrap">
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Hola,<span>Te encuentras dentro del formulario para modificar un tipo de documentos</span></h1>
                            </div>
                        </div>
                    </div>
        ...
        <?php
             ...
             $nombre_tipoDoc = $_GET['nombre_tipoDoc'];
             $estatus_tipoDoc = $_GET['estatus_tipoDoc'];
             $fecha_tipoDoc = $_GET['fecha_tipoDoc'];
            ?>
        <div class="container">
            ...
            <div class="container">
                <div class="col-lg-12">
                    <div class="registration-form">
                        <form action="../Modelo/TipoDocModificar.php" method="POST" style="text-align: center">
                            <h1>Modificación de tipo de documento</h1>
                            <br>
                            <div class="form-group">
                                <input class="form-control" type="hidden" name="idtipos_documentos" value="<?=$idtipos_documentos?>">

                                <label for="nombre_tipoDoc">Nombre del tipo de documento</label>
                                <input class="form-control" type="text" name="nombre_tipoDoc" value="<?=$nombre_tipoDoc?>"  required>
                                <br>
                                <label for="estatus_tipoDoc">Estatus</label>
                                <select name="estatus_tipoDoc" class="form-control" value="<?=$estatus_tipoDoc?>" required >
                                ...
                                <input class="form-control" type="date" name="fecha_tipoDoc" value="<?=$fecha_tipoDoc?>" readonly>
                                <br>
