                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Hola,<span> Te encuentras dentro del formulario para registrar un nuevo departamento</span></h1>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="col-lg-12">
                    <div class="registration-form">
                        <form action="../Modelo/DepartamentoInsertar.php" method="POST" style="text-align: center">
                            <h1>Registro de un nuevo departamento</h1>
                            <br>
                            <div class="form-group">
                                <label for="nombre_departamento_usuarios">Nombre del nuevo departamento</label>
                                <input class="form-control" type="text" name="nombre_departamento_usuarios" required>
                                <br>
                                <label for="fecha_departamento">Fecha de registro</label>
                                <input class="form-control" type="date" name="fecha_departamento" value="<?php echo date("Y-m-d");?>" readonly>
                                <br>
