    ...
    <div class="content-wrap">
        <div class="main">
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Hola,<span>Te encuentras dentro del formulario para modificar una plantilla</span></h1>
                            </div>
                        </div>
                    </div>
            ...
            <?php
                ...
                $descripcion_plantillas = $_GET['descripcion_plantillas'];
                $ruta_plantilla = $_GET['ruta_plantilla'];
                $fecha_plantilla = $_GET['fecha_plantilla'];
                $estatus_plantilla = $_GET['estatus_plantilla'];
                $tipo_documento = $_GET['tipo_documento'];
            ?>
        <div class="container">
            <a href="../Vista/GestionPlantillas.php">
                <button class="btn btn-danger" type="submit">Regresar</button>
            </a> 
            <div class="container">
                <div class="col-lg-12">
                    <div class="registration-form">
                        <form action="../Modelo/PlantillasEditar.php" method="POST" style="text-align: center" enctype="multipart/form-data">
                            <h1>Modificación de una plantilla</h1>
                            <br>
                            <div class="form-group">
                                <input class="form-control" type="hidden" name="idplantillas_documentos" value="<?=$idplantillas_documentos?>">
                                <input class="form-control" type="hidden" style="text" name="ruta_plantilla" value="<?=$ruta_plantilla?>">
                                
                                <label for="descripcion_plantillas">Descripción de la plantilla:</label>
                                <input class="form-control" type="text" name="descripcion_plantillas" value="<?=$descripcion_plantillas?>" required>
                                <br>
                                <label for="fecha_plantilla">Fecha de registro:</label>
                                <input class="form-control" type="date" name="fecha_plantilla" value="<?=$fecha_plantilla?>" readonly>
                                <br>
                                <input name="casilla" type="checkbox" onchange="evaluarEst(this);"/>
                                <label for="casilla">¿Se requiere cambiar el estatus?</label>
                                <select name="estatus_plantilla"  class="form-control" id="boton1" style="display:none" readonly>
                                    <option value="<?=$estatus_plantilla?>" >Si no se reqioere cambiar deje esta acción selecciona</option>
                                ...
                                <?php
                                    include("../Controlador/Conexion.php");
                                    $conexion =  mysqli_connect($servidor,$user,$password,$database);
                                    $sql2 = "SELECT * FROM tipos_documentos";
                                    $resultado = mysqli_query($conexion,$sql2);
                                ?>
                                <label for="tipo_documento">Tipo de documento</label>
                                <select name="tipo_documento" class="form-control" required>
                                    <option value="<?=$tipo_documento?>">Si no se requiere el cambio de tipo de documentos</option>
