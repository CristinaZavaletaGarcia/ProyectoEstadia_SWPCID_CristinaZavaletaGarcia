                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Hola,<span>Te encuentras dentro del formulario para registrar un nuevo encargado de área</span></h1>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="col-lg-12">
                    <div class="registration-form">
                        <form action="../Modelo/EncargadoAreaRegistrar.php" method="POST" style="text-align: center">
                            <h1>Registro de un nuevo encargado de área</h1>
                            <br>
                            <div class="form-group">
                                ...
                                <?php
                                    include("../Controlador/Conexion.php");
                                    $conexion =  mysqli_connect($servidor,$user,$password,$database);
                                    $sql2 = "SELECT * FROM tipos_usuarios where tipo='Encargado'";
