                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Hola,<span> Te encuentras dentro de la visualización de la gráfica pendientes y archivados para generar un reporte</span></h1>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="col-lg-12">
                    <div class="registration-form">
                        <form action="../Vista/ReportePendiArchiGrafica.php" method="POST" style="text-align: center">
                            <h1>Reporte por documentos "Pendientes y Archivados"</h1>
                            <br>
                            <div class="form-group">
                                <label for="FechaMes">Selecciona el mes para realizar el reporte:</label>
                                <select name="FechaMes" class="form-control" required>
                                ...
                                <br>
                                <button class="btn btn-primary" type="submit">Realizar gráfica</button>
                            </div> 
                        </form>   
                    </div>
                </div>
