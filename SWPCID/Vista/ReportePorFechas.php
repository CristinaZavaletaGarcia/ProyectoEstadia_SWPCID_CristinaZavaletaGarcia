...
<!--Función para ocultar los inputs dependiento la opción del select-->
<script>
       function showInp(){
  ...
  switch (getSelectValue) {
    case "dia": 
      document.getElementById("dia1").style.display = "inline-block";
      document.getElementById("dia").style.display = "inline-block";
      document.getElementById("dia").setAttribute("required", "required");
    ...
    case "semana":
      document.getElementById("rango").style.display = "inline-block";
      document.getElementById("fecha1").style.display = "inline-block";
      document.getElementById("fecha2").style.display = "inline-block";
      document.getElementById("rango").setAttribute("required", "required");
      document.getElementById("fecha1").setAttribute("required", "required");
    ...
    case "mes":
      document.getElementById("Mes1").style.display = "inline-block";
      document.getElementById("Mes").style.display = "inline-block";
      document.getElementById("Mes").setAttribute("required", "required");
      document.getElementById("rango").style.display = "none";
      document.getElementById("fecha1").style.display = "none";
      document.getElementById("fecha2").style.display = "none";
      document.getElementById("dia1").style.display = "none";
...
<body>
   ...
   <div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures bg-success">
    ...
    <div class="content-wrap">
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Hola,<span>Te encuentras dentro del formulario para realizar un reporte por fechas</span></h1>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <a href="../Vista/VistaReportes.php">
                <button class="btn btn-danger" type="submit">Regresar</button>
            </a>  
            <div class="container">
                <div class="col-lg-12">
                    <div class="registration-form">
                        <form action="../Modelo/ReportePorFechas.php" method="POST" style="text-align: center">
                            <h1>Reporte por fechas</h1>
                            <br>
                            <div class="form-group">
                            <label for="" id="">Selecciona una opción para realizar el reporte</label>
                            <select name="Opciones" id="telprefix" class="form-control" onchange="showInp()" required>
                                <option value="">Selecciona una opción</option>
                                <option value="dia">Por dia</option>
                                <option value="semana">Por rango de semana</option>
                                <option value="mes">Por mes</option>
                            </select>
                            <br>
                            <label name="FechaDia" for="" id="dia1" style="display: none">Selecciona un dia:</label>
                            <input name="FechaDia" class="form-control" id="dia" type="date" style="display: none"/>
                            <label for="" id="rango" style="display: none">Selecciona las fechas:</label>
                            <input name="Fecha1" class="form-control" id="fecha1" type="date" style="display: none"/>
                            <br>
                            <br>
                            <input name="Fecha2" class="form-control" id="fecha2" type="date" style="display: none"/>
                            <label name="" for="" id="Mes1" style="display: none">Selecciona un mes:</label>
                            <select class="form-control" name="Mes" id="Mes" style="display: none" required>
                            ...
                            <br>
                            <br>
                            <button class="btn btn-primary" type="submit">Realizar reporte</button>
                            </div> 
                        </form>   
                    </div>
                </div>
