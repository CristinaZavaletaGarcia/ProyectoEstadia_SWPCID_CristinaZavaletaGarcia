                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Hola,<span>Te encuentras dentro del formulario para modificar el archivo de una plantilla</span></h1>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="container">
                <div class="col-lg-12">
                    ...
                    <form action="../Modelo/PlantillasEditarDocumento.php" method="POST" style="text-align: center" enctype="multipart/form-data">
                            <h1>Modificación del archivo de la plantilla</h1>
                            <br>
                            <div class="form-group">
                                <input type="hidden" name="idplantillas_documentos" value="<?=$idplantillas_documentos?>">
                                <br>
