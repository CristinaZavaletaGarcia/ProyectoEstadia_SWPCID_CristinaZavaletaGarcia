...
<body>
   ...
   <div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures bg-success">
    ...
    <div class="content-wrap">
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Hola,<span>Te encuentras del modulo para enviar mensajes por correo electronico</span></h1>
                            </div>
                        </div>
                    </div>
        ...
        <!--Opciones para la realización de los reportes-->
        <div class="container" align="center">
            <img src="../Vista/images/R4.png" width="400" height="400"/>
            <h1>NOTIFICACIONES IMPORTANTES</h1>
            <!--Botones para los diferentes notificaciones-->
            <div class="container">
                <a href="../Vista/NotificacionesCoordinadorUrgente.php">
                    <button class="btn btn-danger" type="submit">Notificación de urgencia</button>
                </a>
                <a href="../Vista/NotificacionesCoordinadorAsignación.php">
                    <button class="btn btn-success" type="submit">Notificación de asignación</button>
                </a>
                <a href="../Modelo/NotificacionesInformación.php">
                <button class="btn btn-info" type="submit">Notificación de información</button>
                </a>
            </div>
        </div>
    </div>
