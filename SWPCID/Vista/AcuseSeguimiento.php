        ...
        <div class="container">
            ...
            <div class="container">
                <div class="col-lg-12">
                    ...
                    <form action="../Modelo/AcuseSeguimeintoInsertar.php" method="POST" style="text-align: center" enctype="multipart/form-data">
                            <h1>Subir acuse de seguimeinto</h1>
                            <br>
                            <div class="form-group">
                                <input type="hidden" name="idseguimiento_documento" value="<?=$idseguimiento_documento?>">
                                <br>
                                <label for="acuse_segimiento">Documento que sera registrado:</label><br>
                                <br>
                                <input type="file" name="acuse_segimiento" required><br>
                                <br>
                                <button class="btn btn-success" type="submit">Subir Acuse</button>
                            </div> 
                        </form>      
                    </div>
                </div>
