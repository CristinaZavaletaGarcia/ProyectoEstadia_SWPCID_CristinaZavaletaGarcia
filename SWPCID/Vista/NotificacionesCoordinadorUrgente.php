...
<body>
    ...
    <div class="content-wrap">
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Hola, <span>Te encuentras dentro del formulario para mandar una notificación por correo electrónico de urgencia</span></h1>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <a href="../Vista/VistaNotificaciones.php">
                <button class="btn btn-danger" type="submit">Regresar</button>
            </a> 
            <!--Inicio del formulario de las notificaciones urgentes-->
            <div class="container">
                <div class="col-lg-12">
                    <div class="registration-form">
                        <form action="../Modelo/NotificacionesCoordinadorUrgencia.php" method="POST" style="text-align: center">
                            <h1>Notificaciones por correo electrónico de urgencia</h1>
                            <br>
                            <div class="form-icon">
                                <span><i class="icon icon-user"></i></span>
                            </div>
                            <div class="form-group">
                                <!--Obtencios de los correos electronicos-->
                                <?php
                                    include("../Controlador/Conexion.php");
                                    $conexion =  mysqli_connect($servidor,$user,$password,$database);
                                    $sql2 = "SELECT * FROM datos_usuarios where idtipos_usuarios != 1 and idtipos_usuarios!=2 ";
                                ...
                                <select name="dirigido" class="form-control" required >
                                    ...
                                    <?php while($mostrar =  $resultado->fetch_assoc()) { ?>
                                        <option value="<?php echo $mostrar['correo_electronico'];?>"><?php echo $mostrar['correo_electronico']; ?></option>
                                    <?php } ?>
                                </select>
                                <br>
                                <!--Infromación del formulario que se rellena aleatoriamente-->
                                <label for="remitenten_notificacion">Remitente</label>
                                <input class="form-control" type="text" name="remitenten_notificacion" value="<?php echo ($row['Nombre_completo']);?>" readonly>
                                <br>
                                <label for="fecha_notificacion">Fecha de la notificació:</label>
                                <input class="form-control" type="date" name="fecha_notificacion" value="<?php echo date("Y-m-d");?>" readonly>
                                <br>
                                <label for="asunto_notificacion">Asunto del correo</label>
                                <input class="form-control" type="text" name="asunto_notificacion" value="Entrega de documentos de urgencia" readonly>
                                <br>
                                <label for="mensaje_notificacion">Mensaje del correo</label>
                                <br>
                                <textarea name="mensaje_notificacion" cols="45" rows="3" required>Necesitamos el documento marcado con prioridad "Urgente" sea entregado en el departamento de coordinación</textarea>
                                <br>
                                <input class="form-control" type="hidden" name="usuarios_idUsuarios" value="<?php echo ($row['iddatos_usuario']);?>" readonly> 
                                <br>
                                <button type="submit" class="btn create-account  bg-primary">Enviar</button><!--Boton para iniciar sesión-->
                            </div> 
                        </form>   
                    </div>
                </div>
