...
<body>
    ...
    <div class="content-wrap">
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Hola,<span>Te encuentras dentro del formulario para Modificar un encargado de área</span></h1>
                            </div>
                        </div>
                    </div>
        ...
        ?>
        <div class="container">
            <a href="../Vista/GestionEncargadosArea.php">
                <button class="btn btn-danger" type="submit">Regresar</button>
            </a> 
            <div class="container">
                <div class="col-lg-12">
                    <div class="registration-form">
                        <form action="../Modelo/EncargadosAreaModificar.php" method="POST" style="text-align: center">
                            <h1>Modificación de un encargado de área</h1>
                            <br>
                            <div class="form-group">
                                <input class="form-control" type="hidden" name="iddatos_usuario" value="<?=$iddatos_usuario?>">

                                <label for="nombre">Nombre del encargado de área</label>
