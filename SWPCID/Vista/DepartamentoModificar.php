...
<body>
    ...
    <div class="content-wrap">
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Hola,<span>Te encuentras dentro del formulario para la modificación de un departamento</span></h1>
                            </div>
                        </div>
                    </div>
        ...
        <?php
            ...
            $nombre_departamento_usuario = $_GET['nombre_departamento_usuario'];
            $estatus_departamento = $_GET['estatus_departamento'];
            $fecha_departamento = $_GET['fecha_departamento'];
        ?>
        <div class="container">
            <a href="../Vista/GestionDepartamenetos.php">
                <button class="btn btn-danger" type="submit">Regresar</button>
            </a> 
            <div class="container">
                <div class="col-lg-12">
                    <div class="registration-form">
                        <form action="../Modelo/DepartamentoModificar.php" method="POST" style="text-align: center">
                            <h1>Modificación de un nuevo departamento</h1>
                            <br>
                            <div class="form-group">
                                <input class="form-control" type="hidden" name="iddepartamentos_usuarios" value="<?=$iddepartamentos_usuarios?>">

                                <input name="chec" type="checkbox" id="chec" onchange="comprobar();"/>
                                <label for="chec">¿Se requiere cambiar el nombre del departamento?</label>
                                <input class="form-control" type="text" name="nombre_departamento_usuario" id="boton" value="<?=$nombre_departamento_usuario?>" readonly>
                                <br>
                                <label for="estatus_departamento">Estatus</label>
                                <select class="form-control" name="estatus_departamento" required>
                                    <option value="">Selecciona una opción:</option>
                                    <option value="1">Activo</option>
                                    <option value="0">Inactivo</option>
                                </select>
                                <br>
                                <label for="fecha_departamento">Fecha de registro</label>
                                <input class="form-control" type="date" name="fecha_departamento" value="<?=$fecha_departamento?>" required>
                                <br>
