...
<body>
   ...
   <div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures bg-primary">
    ...
    <div class="content-wrap">
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Hola,<span>Te encuentras dentro del formulario para Modificar un coordinador</span></h1>
                            </div>
                        </div>
                    </div>
        ...
        ?>
        <div class="container">
            <a href="../Vista/GestionCoordinadores.php">
                <button class="btn btn-danger" type="submit">Regresar</button>
            </a> 
            <div class="container">
                <div class="col-lg-12">
                    <div class="registration-form">
                        <form action="../Modelo/CoordinadorModificar.php" method="POST" style="text-align: center">
