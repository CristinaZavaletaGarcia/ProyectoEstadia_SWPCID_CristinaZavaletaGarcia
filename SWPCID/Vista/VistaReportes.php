...
<body>
   ...
   <div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures bg-success">
    ...
    <div class="content-wrap">
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Hola,<span>Te encuentras del módulo para realizar reportes en formato PDF</span></h1>
                            </div>
                        </div>
                    </div>
        ...
        <!--Opciones de la vista de las plantillas-->
        <div class="container" align="center">
            <img src="../Vista/images/R10.png" width="400" height="400"/>
            <h1>REPORTES EN PDF</h1>
            <!--Botones-->
            <div class="container">
                <a href="../Vista/ReportePorFechas.php">
                    <button class="btn btn-warning" type="submit">Por fecha</button>
                </a>
                <a href="../Vista/ReportesTipoDoc.php">
                    <button class="btn btn-success" type="submit">Por tipo de documento</button>
                </a>
                <a href="../Vista/ReportePendiArchi.php">
                    <button class="btn btn-info" type="submit">Pendientes y archivados</button>
                </a>
            </div>
        </div>
    </div>
