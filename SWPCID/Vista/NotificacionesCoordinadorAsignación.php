...
<body>
    ...
    <div class="content-wrap">
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Hola, <span>Te encuentras dentro del formulario para mandar una notificación por correo electrónico de asignación</span></h1>
                            </div>
                        </div>
                    </div>
        ...
        <!--Fomrulario para el envio de notificaciones por correo electronico de asignación-->
        <div class="container">
            ...
            <div class="container">
                <div class="col-lg-12">
                    <div class="registration-form">
                        <form action="../Modelo/NotificacionesCoordinadorAsignación.php" method="POST" style="text-align: center">
                            <h1>Notificaciones por correo electrónico de Asigación</h1>
                            <br>
                            <div class="form-icon">
                                <span><i class="icon icon-user"></i></span>
                            </div>
                            <div class="form-group">
                                <!--Obtención de los correos electronico-->
                                <?php
                                    include("../Controlador/Conexion.php");
                                    $conexion =  mysqli_connect($servidor,$user,$password,$database);
                                ...
                                <input class="form-control" type="text" name="asunto_notificacion" value="Asignación de numero de folio" readonly>
                                <br>
                                <label for="mensaje_notificacion">Mensaje del correo</label>
                                <br>
                                <textarea name="mensaje_notificacion" cols="45" rows="3" required>Su numero de folio ya fue apartado, revise su modulo de, seguimeinto se asignación de nuemero de folio</textarea>
                                <br>
