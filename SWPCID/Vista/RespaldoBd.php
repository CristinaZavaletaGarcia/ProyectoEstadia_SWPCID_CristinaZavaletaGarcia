...
<body>
    ...
    <div class="content-wrap">
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Hola,<span>Te encuentras dentro la página para realizar el respaldo de la base de datos</span></h1>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container" align="center">
            <img src="../Vista/images/R8.png" alt="Esta es una descripcion alternativa de la imagen para cuando no se pueda mostrar" width="500" height="400"/>
            <h1>Respaldo de la base de datos</h1>
            <a href="../Modelo/RespaldoBd.php">
                <button class="btn btn-primary" type="submit">Respaldo</button>
            </a>
        </div>
    </div>
