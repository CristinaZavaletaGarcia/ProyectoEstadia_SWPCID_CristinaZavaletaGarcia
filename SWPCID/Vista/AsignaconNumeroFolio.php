...
<body>
    ...
    <div class="content-wrap">
        ...
        <?php
            ...
            $Asunto_solicitud = $_GET['Asunto_solicitud'];
            $destinado_solicitud = $_GET['destinado_solicitud'];
            $prioridad_solicitud = $_GET['prioridad_solicitud'];
            $estatus_solicitudFolio = $_GET['estatus_solicitudFolio'];
            $usuarios_idUsuarios =$_GET['usuarios_idUsuarios'];
            $tipo_doc =$_GET['tipo_doc'];
        ?>
        <div class="container">
            <a href="../Vista/SolicitudesFolio.php">
                <button class="btn btn-danger" type="submit">Regresar</button>
            </a> 
            <div class="container">
                <div class="col-lg-12">
                    <div class="registration-form">
                        <form action="../Modelo/RegistraNumeroFolio.php" method="POST" style="text-align: center">
                            <h1>Registro de una nueva solicitud de numero de folio</h1>
                            <br>
                            <div class="form-group">
                                <label for="fecha_recibido">Fecha de la solicitud</label>
                                <input class="form-control" type="date" name="fecha_recibido" value="<?=$fecha_solicitud?>" readonly>
                                <br>
                                <label for="fecha_documento">Fecha del documento</label>
                                <input class="form-control" type="date" name="fecha_documento" value="<?=$fecha_solicitud?>" readonly>
                                <br>
                                <label for="numero_documento">Numero del documento</label>
                                <input class="form-control" type="text" name="numero_documento" value="Folio apartado" readonly>
                                <br>
                                <label for="remitente_documento">Remitente</label>
                                <input class="form-control" type="text" name="remitente_documento" value="<?=$usuarios_idUsuarios?>" readonly>
                                <br>
                                <label for="asunto_documento">Asunto de la solicitud</label>
                                <input class="form-control" type="text" name="asunto_documento" value="<?=$Asunto_solicitud?>" readonly>
                                <br>
                                <label for="destinatario_documento">Destino de la solicitud</label>
                                <input class="form-control" type="text" name="destinatario_documento" value="Folio apartado" readonly>
                                <br>
                                <label for="introduccion_documento">Introducción</label>
                                <input class="form-control" type="text" name="introduccion_documento" value="Folio apartado" readonly>
                                <br>
                                <label for="recibido_documento">Recibido por</label>
                                <input class="form-control" type="text" name="recibido_documento" value="<?php echo $row['usuario']?>" readonly>
                                <br>
                                <label for="prioridad_documento">Prioridad</label>
                                <input class="form-control" type="text" name="prioridad_documento" value="<?=$prioridad_solicitud?>" readonly>
                                <br>
                                <label for="estatus_doc">Estatus</label>
                                <input class="form-control" type="text" name="estatus_doc" value="<?=$estatus_solicitudFolio?>" readonly>
                                <br>
                                ...
                                <input class="form-control" type="text" name="num_oficio" value="<?=$idsolicitudes_folio?>" readonly>
                                <br>
