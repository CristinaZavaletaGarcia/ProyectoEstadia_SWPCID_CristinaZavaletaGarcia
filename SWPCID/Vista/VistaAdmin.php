...
<body>
                    ...
                    <div class="float-right">
                        <div class="dropdown dib">
                            ...
                            <a href="../Controlador/logout.php">
                                <button type="submit" class="btn create-account  bg-primary">Cerrar Sesión</button><!--Boton para iniciar sesión-->
                            </a>   
                        </div>
                    </div>
                    <li>
    ...
    <div class="content-wrap">
                ...
                <div class="row">
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            ...
                            <div class="page-title">
                                <h1><span>Las opciones del usuario administrador se encuentran en el menú de lado izquierdo</span></h1>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container" align="center">
            <img src="../Vista/images/R2.png" alt="Esta es una descripcion alternativa de la imagen para cuando no se pueda mostrar" width="400" height="400"/>
