       ...
       if($validando3 ->num_rows > 0){
           ...
           if(!$resultado){
               ...
               while($mostrar =  $resultado_ultimo->fetch_assoc()){
                   ...
                   $sql_one = "UPDATE datos_usuarios SET firma_dato=CONCAT(LEFT(nombre,1),LEFT(apellidoP,1),LEFT(apellidoM,1),'Encargado',LEFT(iddatos_usuario,2)) Where iddatos_usuario='$id'";
