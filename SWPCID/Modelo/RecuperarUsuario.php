...
$resultado = mysqli_query($conexion,$sql);
    while($mostrar =  $resultado->fetch_array()){
        ...
        if($mostrar['Cantidad']>0){
            $sql_1= "INSERT INTO recuperarcontra (estado,codigo,fecha_contra,usuarios_idUsuarios,tipo_recupera) VALUES (1,'$codigo','$date',$id_usuario,'Usuario')";
            ...
            try {
                ...
                //Recipients
                $mail->setFrom('cristina1h99@gmail.com',utf8_decode('Recuperación de usuario'));
                ...
                location.href="../Vista/GenerarNuevoUsuario.php?correo='.$correo.'&id='.$id_usuario.'";
                </script>';
            } catch (Exception $e) {
